...
#         if not course_id:
#             return Response({"detail": "Поле 'course_id' обязательно."}, status=status.HTTP_400_BAD_REQUEST)
#
...
#             status_code = status.HTTP_200_OK # 200 OK, так как действие выполнено успешно
#         # Если подписки у пользователя на этот курс нет - создаем ее
#         else:
#             try:
#                 Subscription.objects.create(user=user, course=course_item)
#                 message = 'Подписка успешно добавлена.'
#                 status_code = status.HTTP_201_CREATED # 201 Created, так как ресурс создан
